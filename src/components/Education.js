      ...
      <div className="container education">
        <div className="row">
          <div className="col-md-6">
            <h2 className="text-danger fa fa-graduation-cap ed">
              {" "}
              School & Education
            </h2>
            <hr />
            <p>
              <b>College Name:</b> {this.state.SchoolName}
            </p>
            <p>
              <b>Degree:</b> {this.state.EducationLevel}
            </p>
            <p>
              <b>Field Studied:</b> {this.state.FieldStudied}
            </p>
            <p>
              <b>Year graduated:</b>{" "}
              <span className="text-primary">{this.state.GratuatedYear}</span>
            </p>
          </div>
          <div className="col-md-6">
            <h3 className="text-danger">React State</h3> <hr />
            <p className="text-primary">
              This is how you display or render React [STATE] using React
              Component class.
            </p>
          </div>
        </div>
